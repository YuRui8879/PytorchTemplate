...
class DenseNet121(nn.Module):
    def __init__(self,num_classes = 1000) -> None:
        ...
        self.dense = DenseNet_BC(growth_rate=32, block_config=(6, 12, 24, 16), num_classes=num_classes)
...
class DenseNet169(nn.Module):
    def __init__(self,num_classes = 1000) -> None:
        ...
        self.dense = DenseNet_BC(growth_rate=32, block_config=(6, 12, 32, 32), num_classes=num_classes)
...
class DenseNet201(nn.Module):
    def __init__(self,num_classes = 1000) -> None:
        ...
        self.dense = DenseNet_BC(growth_rate=32, block_config=(6, 12, 48, 32), num_classes=num_classes)
...
class DenseNet264(nn.Module):
    def __init__(self,num_classes = 1000) -> None:
        ...
        self.dense = DenseNet_BC(growth_rate=32, block_config=(6, 12, 64, 48), num_classes=num_classes)
...
class DenseNet_BC_100(nn.Module):
    def __init__(self,num_classes = 100) -> None:
        super(DenseNet_BC_100,self).__init__()
        self.dense = DenseNet_BC(growth_rate=12, block_config=(16, 16, 16), num_classes = num_classes)
